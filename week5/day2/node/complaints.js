const complaint000 = require("./consts")
const handleComplaint = require("./complaintsHandler")
let complaint1 = {
    text: "I'm not getting enough money",
    type: complaint000.finance//use the FINANCE type from the consts module
}
...
let complaint3 = {
    ...
    type:complaint000.emotions //use the EMOTIONS type from the consts module
}
